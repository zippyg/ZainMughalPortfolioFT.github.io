  ...
  <div>
    ...
    <main>
      <section id="project-detail">
        ...
        <figure>
          <img src="/portfolio resources/Screenshot 2024-06-23 at 12.32.24.png" alt="Project 1" />
          <figcaption><button onClick={() => window.open('#', '_blank')}>View Project Files</button></figcaption>
        </figure>
